...
export default function AppRoutes() {
  return <Routes>
    ...
    <Route path="/admin" element={<AdminLayout><Placeholder title="Admin Portal" /></AdminLayout>} />
    <Route path="/admin/dashboard" element={<AdminLayout><Dashboard /></AdminLayout>} />
    <Route path="/admin/students" element={<AdminLayout><Placeholder title="Students" /></AdminLayout>} />
